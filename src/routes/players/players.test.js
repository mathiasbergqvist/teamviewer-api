...
describe('Players API', () => {
    ...
    describe('GET /players', () => {
        it('should respond with 200 success', async () => {
            const response = await request(app).get('/v1/players').expect('Content-Type', /json/).expect(200);
    ...
    describe('GET /player/:id', () => {
        ...
        it('should catch missing required properties', async () => {
            const response = await request(app).get('/v1/players/invlaidId').expect(400);
        ...
        it('should respond with 404 not found if player is missing', async () => {
            ...
            await request(app).get('/v1/players/64e3c4c4c1a6bf8a6f961fb2').expect(404);
        });
    });
    ...
    describe('DELETE /player', () => {
        ...
        it('should respond with 404 not found if player is missing', async () => {
            ...
            await request(app).delete('/v1/players/64e3c4c4c1a6bf8a6f961fb2').expect(404);
        });
    });
});
